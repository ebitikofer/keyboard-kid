...
bool environment::loadMedia(int c)
{
...
bool environment::loadStartMedia()
{
  //Loading success flag
  bool success = true;
...
int environment::randomNumber(const int& start, const int& end) {
